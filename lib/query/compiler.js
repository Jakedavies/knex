...
(0, _assign3.default)(QueryCompiler.prototype, {
  ...
  withRecursiveRaw: function withRecursiveRaw(statement) {
  ...
  withRecursiveWrapped: function withRecursiveWrapped(statement) {
    ...
    return val && recursive && 'recursive ' + this.formatter.columnize(statement.alias) + ' as (' + val + ' union all ' + recursive + ')' || '';
  },
