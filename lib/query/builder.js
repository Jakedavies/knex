...
(0, _assign3.default)(Builder.prototype, {
  ...
  withRecursive: function withRecursive(alias, statement, bindings) {
    if (typeof alias !== 'string') {
  ...
  withRecursiveRaw: function withRecursiveRaw(alias, sql, bindings) {
    var raw = sql instanceof _raw2.default ? sql : this.client.raw(sql, bindings);
    this._statements.push({
      grouping: 'with',
  ...
  withRecursiveWrapped: function withRecursiveWrapped(alias, callback, recursiveCallback) {
    this._statements.push({
      grouping: 'with',
